...
- **App**: Dealio — The pipeline that moves itself.
...
- **Bound guuey app**: `ba9ab3df-c663-47cc-87dc-d9591a872321` (release). NEVER hand-edit this id — re-run `pnpm bootstrap -- --link` to rebind.
- **Agent endpoint**: https://ba9ab3df-c663-47cc-87dc-d9591a872321.agents.us-east-1.guuey.com
