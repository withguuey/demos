...
- **App**: Trimly — The booking page that books itself.
...
- **Bound guuey app**: `53e3b162-fb0e-4ad1-88ec-ff3bcc505336` (release). NEVER hand-edit this id — re-run `pnpm bootstrap -- --link` to rebind.
- **Agent endpoint**: https://53e3b162-fb0e-4ad1-88ec-ff3bcc505336.agents.us-east-1.guuey.com
