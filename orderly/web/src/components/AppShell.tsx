...
const GUUEY_EXIT_URL =
  "https://guuey.com/hire-a-rep?utm_source=demo&utm_medium=referral&utm_campaign=channel&utm_content=orderly-shell";
 ...
 * and a dark card lands on the paper app (caught live). Module scope
      ...
      <div className="app-body">
        <aside className="sidebar">
          ...
          <nav className="sidebar-menus">
            ...
            <NavLink to="/app/refunds" onClick={() => setCanvasShowsView(false)}>
              Refunds
            </NavLink>
