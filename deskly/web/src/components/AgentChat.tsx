...
/**
 * Precision Grid, projected onto the chat kit's token schema (#302:
 ...
 * real surface they sit on (muted ink over #171b22 ⇒ #a6adb8).
 */
const PRECISION_GRID_CHAT_THEME: GuueyChatTheme = {
  name: "precision-grid",
  colors: {
    light: {
      accent: "#101318",
...
export function AgentChat({
  ...
  const shared = {
    ...
    theme: PRECISION_GRID_CHAT_THEME,
    className,
    style,
