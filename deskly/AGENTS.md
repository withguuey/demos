...
- **App**: Deskly — The helpdesk that triages itself.
...
- **Bound guuey app**: `fcac88b7-9e95-45aa-968d-7e703fdc7bbc` (release). NEVER hand-edit this id — re-run `pnpm bootstrap -- --link` to rebind.
- **Agent endpoint**: https://fcac88b7-9e95-45aa-968d-7e703fdc7bbc.agents.us-east-1.guuey.com
